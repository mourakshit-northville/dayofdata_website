...
This portfolio is intended to show how I approach architecture decisions, trust boundaries, governance, observability, and production-readiness when applying modern AI capabilities to enterprise data.
...
| [Databricks AI Governance Reference](./databricks-ai-governance/README.md) | Unity Catalog, AI Gateway, MLflow, policy enforcement, lineage, and auditability |
